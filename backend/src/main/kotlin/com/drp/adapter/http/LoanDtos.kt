...
import com.drp.application.usecase.ExternalLoanView
import com.drp.application.usecase.LoanParticipantCommand
import com.drp.application.usecase.LoanView
...
data class LoanParticipantResponse(
    ...
    companion object {
        fun of(participant: com.drp.domain.loan.LoanParticipant) = LoanParticipantResponse(
