...
data class ArticleInput(
    ...
    /** Lo que pesa y ocupa **una** unidad. Cero no vale: para «no lo se» esta el nulo. */
    @field:Positive val unitWeightGrams: BigDecimal? = null,
    @field:Positive val unitVolumeMl: BigDecimal? = null,
