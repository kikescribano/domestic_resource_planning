...
data class ArticleCommand(
    ...
    val unitWeightGrams: BigDecimal? = null,
    val unitVolumeMl: BigDecimal? = null,
...
data class ArticlePatch(
    ...
    val unitWeightGrams: Patch<BigDecimal?> = Patch.Absent,
    val unitVolumeMl: Patch<BigDecimal?> = Patch.Absent,
    ...
    fun create(session: SessionClaims, command: ArticleCommand): Article {
        ...
        return articles.save(
            Article(
                ...
                unitWeightGrams = command.unitWeightGrams,
                unitVolumeMl = command.unitVolumeMl,
    ...
    fun handle(session: SessionClaims, articleId: UUID, patch: ArticlePatch): ArticleView {
        ...
        val saved = articles.save(
            current.copy(
                ...
                unitWeightGrams = patch.unitWeightGrams.orKeep(current.unitWeightGrams),
                unitVolumeMl = patch.unitVolumeMl.orKeep(current.unitVolumeMl),
