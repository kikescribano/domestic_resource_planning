...
| **Cierre de huecos** (bloque entre fases, **no es una fase**) | Los cuatro que las Fases 1 y 2 dejaron abiertos a propósito: baja de hogar y de cuenta, conversión de HEIC, Transactional Outbox y los cuatro atributos propuestos | 🟡 **En curso** — Hitos 0, 1, 2 y 3 cerrados el 2026-08-20 |
...
**Y un quinto que no estaba en ninguna lista**, porque no se dejó abierto sino que apareció ejecutando el bloque (2026-08-20): **el «hoy» de las reglas de calendario es el de UTC y no el del hogar**, así que un hogar peninsular no puede registrar de madrugada lo que acaba de hacer. Entra por el mismo motivo que los otros cuatro —es saldo de las dos fases cerradas, no avance del producto— y ocupa el Hito 5.
