...
> **Fase actual:** Fase 1 (Core MVP) en curso — Hitos 0 y 1 completados; el alcance, los hitos y su estado viven en [`docs/common/product/roadmap.md`](docs/common/product/roadmap.md)
