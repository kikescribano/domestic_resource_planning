...
El **registro vivo de decisiones** del core: treinta y dos validadas, cada una con su alternativa descartada y el motivo, más cuatro pendientes que siguen abiertas a propósito —peso y volumen de un asset (destinatario: Warehouse), baja de un hogar, análisis antivirus y cuatro atributos propuestos—.
