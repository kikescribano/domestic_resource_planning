...
> **Pendiente de validar:** no hay **política de contraseñas** en ninguna parte — ni longitud mínima, ni requisitos, ni comprobación contra filtraciones conocidas. Hasta ahora apenas se notaba porque solo elegía contraseña quien abría un hogar; con la invitación y el restablecimiento hay tres puntos donde se fija una. Queda `Por decidir` en lugar de inventar un mínimo arbitrario, pero conviene cerrarlo antes de escribir el primero de esos tres flujos.
