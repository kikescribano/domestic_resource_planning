...
| **Despliegue** (bloque entre fases, **no es una fase**) | DRP en producción en el VPS de OVH: compose de producción, imágenes desde GHCR, correo real, tope de hogares y el juego de demostración cargado — **sin dominio ni TLS todavía**, a propósito | 🟢 **Completado** el 2026-08-21 ([ADR-016](docs/common/architecture/decisions/ADR-016-production-deployment.md)) |
