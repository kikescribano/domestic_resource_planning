...
>
> **Desde el 2026-08-21 el despliegue existe** ([ADR-016](docs/common/architecture/decisions/ADR-016-production-deployment.md) y [`deployment.md`](docs/backend/operations/deployment.md)): DRP corre en el VPS, con el hogar de demostración dentro. **Los estados de esta tabla no cambian todavía, y el motivo se muda**: lo que separa «En desarrollo» de «En producción» ya no es «no hay despliegue» sino que **no hay ningún hogar real dentro** — nadie usa esto aún para saber dónde está el taladro, y las dos decisiones aplazadas a «la primera revisión de operación» siguen esperando esa revisión, que ahora ya tiene dónde ocurrir.
>
