...
> **Fase actual:** Fase 1 (Core MVP) **completada**; cómo se hizo, hito a hito, en [`docs/common/product/roadmap.md`](docs/common/product/roadmap.md). La **Fase 2 está en curso**: los cuatro módulos de prioridad alta de la sección 4.2, sobre activación por hogar y plataforma de avisos, en [`docs/common/product/phase-2-roadmap.md`](docs/common/product/phase-2-roadmap.md). Sus **Hitos 0 a 4 están cerrados**: las fronteras de módulo y la activación por hogar ya existen, el catálogo de los cuatro se puede encender y apagar, la plataforma **programa las comprobaciones periódicas y entrega los avisos** —con lo que los tres procesos diarios del core se ejecutan por fin en un despliegue— y **hay tres módulos construidos**: Proveedores, Warehouse y Compras. Con el último, **los cuatro riesgos arquitectónicos de la fase están retirados** —incluido el principal, dos módulos que se hablan sin depender uno de que el otro esté activo— y el punto de corte de la fase queda declarado: **no se parte, y sigue con CMMS**
...
| Mantenimiento (CMMS) | Mantenimiento preventivo/correctivo de assets (planes, avisos, histórico) | Por diseñar | Alta |
