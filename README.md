...
> **Fase actual:** Fase 1 (Core MVP) **completada**; cómo se hizo, hito a hito, en [`docs/common/product/roadmap.md`](docs/common/product/roadmap.md). La **Fase 2 está en curso**: los cuatro módulos de prioridad alta de la sección 4.2, sobre activación por hogar y plataforma de avisos, en [`docs/common/product/phase-2-roadmap.md`](docs/common/product/phase-2-roadmap.md). Sus **Hitos 0, 1 y 2 están cerrados**: las fronteras de módulo y la activación por hogar ya existen, el catálogo de los cuatro se puede encender y apagar, la plataforma **programa las comprobaciones periódicas y entrega los avisos** —con lo que los tres procesos diarios del core se ejecutan por fin en un despliegue— y **el primer módulo de verdad ya está construido**: Proveedores y contactos de servicio, con su ficha, sus dos tablas, sus siete operaciones y sus pantallas
