...
| **Cierre de huecos** (bloque entre fases, **no es una fase**) | Los cuatro que las Fases 1 y 2 dejaron abiertos a propósito: baja de hogar y de cuenta, conversión de HEIC, Transactional Outbox y los cuatro atributos propuestos | 🟡 **En curso** — Hitos 0 y 1 cerrados el 2026-08-20 |
...
>
> El bloque añade **cuatro ADR** a las once existentes, y van escribiéndose en el hito que las estrena, como en las dos fases anteriores y no al planificar: supresión de datos (ADR-012, Hito 0, escrita) y Transactional Outbox (ADR-013, Hito 1, escrita); quedan la conversión de HEIC (ADR-014, Hito 2) y el color e icono elegidos por el usuario dentro de una paleta certificada (ADR-015, Hito 4).
>
