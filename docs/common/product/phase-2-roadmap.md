...
> **Los tres tienen plan desde el 2026-08-19, y no es la Fase 3.** Esta sección se
> queda como está para que se lea lo que la Fase 2 decidió y por qué. La baja de
> un hogar, la conversión de HEIC y el Transactional Outbox se ejecutan en el
> [cierre de huecos](open-gaps-roadmap.md), un bloque entre fases que además cierra
