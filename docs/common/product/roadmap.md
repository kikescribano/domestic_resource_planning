...
> [cierre de huecos](open-gaps-roadmap.md) completo: la baja de un hogar se lleva
> sus filas y sus ficheros —y el avatar se va con el cierre de cuenta—, la foto
> que hace un iPhone con los ajustes de fábrica se sube y se ve, y los cuatro
> atributos propuestos existen, los cuatro. El único de esta lista que sigue
> fuera es el análisis antivirus, y sigue siendo a propósito.

## Historial

| Fecha | Cambio |
|---|---|
| 2026-08-20 | Se anota, sin tocar lo que la fase decidió, que **los tres huecos con plan están hechos**: el [cierre de huecos](open-gaps-roadmap.md) se completó con sus siete hitos. El análisis antivirus sigue fuera, con el mismo motivo de siempre. |
